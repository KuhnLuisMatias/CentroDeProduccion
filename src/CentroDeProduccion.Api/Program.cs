...
builder.Services.AddScoped<GetSaldoQueryHandler>();
        ...
        builder.Services.AddScoped<RegistrarPagoProveedorCommandHandler>();
        builder.Services.AddScoped<GetPagosProveedorListQueryHandler>();
        builder.Services.AddScoped<GetPagosProveedoresReportQueryHandler>();
